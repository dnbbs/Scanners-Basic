...
<QueryList>
  <Query Id="0" Path="Microsoft-Windows-Sysmon/Operational">
    <Select Path="Microsoft-Windows-Sysmon/Operational">
      *[System[(EventID=10) and TimeCreated[@SystemTime >= '$($BootTime.ToUniversalTime().ToString("o"))']]]
      and
      *[EventData[Data[@Name='TargetImage' and contains(., 'HD-Player.exe')]]]
    </Select>
  </Query>
</QueryList>
"@
    ...
    <Select Path="Microsoft-Windows-Sysmon/Operational">
      *[
        System[
          EventID=10
          and
          TimeCreated[@SystemTime >= '$BootTimeUTC']
        ]
        and
        EventData[
          Data[@Name='GrantedAccess']='0x143A'
          or Data[@Name='GrantedAccess']='0x1F0FFF'
          or Data[@Name='GrantedAccess']='0x1FFFFF'
          or Data[@Name='GrantedAccess']='0x1F3FFF'
          or Data[@Name='GrantedAccess']='0x001F0FFF'
        ]
      ]
    </Select>
  </Query>
