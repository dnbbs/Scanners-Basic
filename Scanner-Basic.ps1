...
$whitelistRoamingAppData = [Environment]::ExpandEnvironmentVariables("%APPDATA%")
...
if ([string]::IsNullOrWhiteSpace($whitelistRoamingAppData)) {
    $whitelistRoamingAppData = "$whitelistUserProfile\AppData\Roaming"
}

$appWhitelistFiles = @(
    "$whitelistProgramFiles\National Instruments\*\niMetaUtils.msm",
    "$whitelistProgramFiles\National Instruments\*\PDF_Handler.xpi",
    "$whitelistProgramFilesX86\National Instruments\*\AngelScript.dll",
    "$whitelistProgramFilesX86\National Instruments\*\BCGControlBar.dll",
    "$whitelistProgramFilesX86\National Instruments\Shared\LabVIEW Run-Time\*\mod_niws.dll",
    "$whitelistProgramFilesX86\National Instruments\Shared\LabVIEW Run-Time\*\NIQtCore_2017.dll",
    "$whitelistProgramFilesX86\National Instruments\Shared\LabVIEW Run-Time\*\NIQtGui_2017.dll",
    "$whitelistProgramFilesX86\National Instruments\Shared\LabVIEW Run-Time\*\NIQtNetwork_2017.dll",
    "$whitelistProgramFilesX86\National Instruments\Shared\LabVIEW Run-Time\*\ni_webdavLVClient.dll",
    "$whitelistProgramFilesX86\National Instruments\Shared\MDF\BinRTE\DKTemplate.msi",
    "$whitelistProgramFilesX86\National Instruments\Shared\MDF\BinRTE\misetup.bin",
    "$whitelistProgramFilesX86\National Instruments\Shared\MDF\BinRTE\niMetaUtils.msm",
    "$whitelistProgramFilesX86\National Instruments\Shared\MIF\MetaSuite\ChilkatDotNet46.dll",
    "$whitelistProgramFilesX86\National Instruments\Shared\MIF\NIMSIProperties\niMetaUtils.msm",
    "$whitelistProgramFilesX86\National Instruments\Shared\Update Service\ChilkatDotNet46.dll",
    "$whitelistProgramFilesX86\National Instruments\Shared\Update Service\niMetaUtils.msm",
    "$whitelistProgramFilesX86\National Instruments\Shared\Update Service\PdfSharp.dll",
    "$whitelistProgramFilesX86\National Instruments\Shared\USI\Bin\PDF_Handler.xpi",
    "$whitelistProgramFiles\Razer\RazerAppEngine\app-*\dxcompiler.dll",
    "$whitelistProgramFiles\Razer\RazerAppEngine\app-*\*\*.dll",
    "$whitelistProgramFiles\Razer\RazerAppEngine\app-*\*\*.exe",
    "C:\Windows\Installer\Razer\Installer\App\libwebp_x64.dll",
    "C:\Windows\Installer\Razer\Installer\App\libwebp_x86.dll",
    "$whitelistProgramFilesX86\Common Files\InstallShield\Professional\RunTime\*\iKernel.dll",
    "$whitelistProgramFilesX86\InstallShield Installation Information\*\CMNSUPT.CAB",
    "$whitelistProgramFilesX86\Common Files\Merge Modules\CW3DGraph_OCX.msm",
    "$whitelistProgramFilesX86\Common Files\Merge Modules\logos.msm",
    "$whitelistProgramFilesX86\Common Files\Merge Modules\logos64.msm",
    "$whitelistProgramFilesX86\Common Files\Merge Modules\niMetaUtils.msm",
    "$whitelistProgramFilesX86\Common Files\Merge Modules\niMetaUtils_x64.msm",
    "$whitelistProgramFilesX86\Creative\ALchemy\dsound.dll",
    "$whitelistProgramFilesX86\Creative\Product Registration\HookWndU.dll",
    "$whitelistProgramFilesX86\Creative\Sound Blaster Play! 3\Sound Blaster Play! 3 Control Panel\CTAudEp.dll",
    "$whitelistProgramFilesX86\Creative\Sound Blaster Play! 3\Sound Blaster Play! 3 Control Panel\HookWndU.dll",
    "$whitelistProgramFilesX86\Creative\Sound Blaster Play! 3\Sound Blaster Play! 3 Control Panel\SBTRed.dll",
    "$whitelistProgramFilesX86\Creative\Sound Blaster Play! 3\Sound Blaster Play! 3 Control Panel\SndCrUSB.DLL",
    "$whitelistProgramFilesX86\Creative\Sound Blaster Play! 3\Sound Blaster Play! 3 Control Panel\*\SBPlay3.resources.dll",
    "$whitelistProgramFilesX86\Steam\libpyrowave-shared-0.dll",
    "$whitelistProgramFilesX86\Steam\steamapps\common\Counter-Strike Global Offensive\game\bin\win64\qtadvanceddocking-qt5.dll",
    "$whitelistProgramFilesX86\Steam\steamapps\common\Counter-Strike Global Offensive\game\bin\win64\qt5_plugins\imageformats\qjpeg.dll",
    "$whitelistProgramFilesX86\Steam\steamapps\common\Counter-Strike Global Offensive\game\bin\win64\qt5_plugins\imageformats\qtiff.dll",
    "$whitelistProgramFilesX86\Steam\steamapps\common\Counter-Strike Global Offensive\game\bin\win64\qt5_plugins\platforms\qwindows.dll",
    "C:\ProgramData\IObitDriverBooster\App\DriverBooster\Register.dll",
    "$whitelistUserProfile\AppData\Local\Mozilla\Firefox\Profiles\*\cache2\entries\33FB8A780747982E980F4F027154C956296F8553",
    "C:\Users\*\AppData\Local\Mozilla\Firefox\Profiles\*\cache2\entries\33FB8A780747982E980F4F027154C956296F8553",
    "$whitelistUserProfile\AppData\Local\Programs\Python\Python*\Lib\site-packages\capstone\lib\capstone.dll",
    "$whitelistUserProfile\AppData\Local\Programs\Python\Python*\Lib\site-packages\Crypto\PublicKey\_ec_ws.pyd",
    "$whitelistUserProfile\AppData\Local\Temp\_MEI*\yara.cp311-win_amd64.pyd",
    "$whitelistUserProfile\AppData\Local\Temp\_MEI*\capstone\lib\capstone.dll",
    "$whitelistUserProfile\AppData\Local\Temp\_MEI*\Crypto\PublicKey\_ec_ws.pyd",
    "$whitelistUserProfile\AppData\Local\Temp\_MEI*\PIL\_imaging.cp311-win_amd64.pyd",
    "$whitelistUserProfile\AppData\Local\Temp\_MEI*\cryptography\hazmat\bindings\_rust.pyd",
    "$whitelistUserProfile\AppData\Local\Temp\_MEI*\libcrypto-3.dll",
    "$whitelistUserProfile\AppData\Local\Temp\_MEI*\python312.dll",
    "$whitelistUserProfile\AppData\Local\Temp\_MEI*\tcl86t.dll",
    "$whitelistUserProfile\AppData\Local\Temp\_MEI*\tk86t.dll",
    "$whitelistProgramFilesX86\BlueStacks X_msi5\green.vbs",
    "$whitelistProgramFilesX86\BlueStacks X_msi5\www\*.js",
    "$whitelistProgramFilesX86\BlueStacks X_msi5\www\js\*.js",
    "$whitelistProgramFilesX86\BlueStacks X_msi5\www\localization\*.js",
    "$whitelistProgramFilesX86\BlueStacks X_msi5\www\script\*.js",
    "$whitelistProgramFilesX86\Microsoft\Edge\Application\*\*.exe",
    "$whitelistProgramFilesX86\Microsoft\Edge\Application\*\*.dll",
    "$whitelistProgramFiles\BraveSoftware\Brave-Browser\Application\*\*.exe",
    "$whitelistProgramFiles\BraveSoftware\Brave-Browser\Application\*\*.dll",
    "$whitelistProgramFiles\Google\Chrome\Application\*\*.exe",
    "$whitelistProgramFiles\Google\Chrome\Application\*\*.dll",
    "$whitelistProgramFiles\obs-studio\*.exe",
    "$whitelistProgramFiles\obs-studio\*.dll",
    "$whitelistProgramFiles\Opera GX\*\*.exe",
    "$whitelistProgramFilesX86\Opera\GX\*\*.exe",
    "$whitelistUserProfile\AppData\Local\Discord\app-*\modules\*\*\*.js",
    "$whitelistUserProfile\AppData\Local\Discord\app-*\*.winmd",
    "$whitelistUserProfile\AppData\Local\Spotify\WasmTtsEngine\*\background_compiled.js",
    "$whitelistUserProfile\AppData\Local\Spotify\WasmTtsEngine\*\bindings_main.js",
    "$whitelistUserProfile\AppData\Local\Spotify\WasmTtsEngine\*\offscreen_compiled.js",
    "$whitelistUserProfile\AppData\Local\Spotify\WasmTtsEngine\*\streaming_worklet_processor.js",
    "$whitelistUserProfile\AppData\Local\BraveSoftware\Brave-Browser\User Data\*\*.js",
    "$whitelistUserProfile\AppData\Local\Google\Chrome\User Data\*\*.js",
    "$whitelistUserProfile\AppData\Local\Microsoft\Edge\User Data\*\*.js",
    "$whitelistUserProfile\AppData\Roaming\Discord\*\*.log",
    "$whitelistUserProfile\AppData\Roaming\Spotify\*\*.log",
    "C:\Users\*\AppData\Local\Programs\Python\Python*\Lib\site-packages\capstone\lib\capstone.dll",
    "C:\Users\*\AppData\Local\Programs\Python\Python*\Lib\site-packages\Crypto\PublicKey\_ec_ws.pyd",
    "C:\Users\*\AppData\Local\Temp\_MEI*\capstone\lib\capstone.dll",
    "C:\Users\*\AppData\Local\Temp\_MEI*\Crypto\PublicKey\_ec_ws.pyd",
    "C:\Users\*\AppData\Local\Temp\_MEI*\PIL\_imaging.cp311-win_amd64.pyd",
    "C:\Users\*\AppData\Local\Temp\_MEI*\yara.cp311-win_amd64.pyd",
    "C:\Users\*\AppData\Local\Temp\_MEI*\cryptography\hazmat\bindings\_rust.pyd",
    "C:\Users\*\AppData\Local\Temp\_MEI*\libcrypto-3.dll",
    "C:\Users\*\AppData\Local\Temp\_MEI*\python312.dll",
    "C:\Users\*\AppData\Local\Temp\_MEI*\tcl86t.dll",
    "C:\Users\*\AppData\Local\Temp\_MEI*\tk86t.dll",
    "C:\Users\*\AppData\Local\Discord\app-*\modules\*\*\*.js",
    "C:\Users\*\AppData\Local\BlueStacks\*.exe",
    "C:\Users\*\AppData\Local\BlueStacks\*.dll",
    "C:\Users\*\AppData\Local\Microsoft\Edge\User Data\*\*.js",
    "C:\Users\*\AppData\Local\Spotify\WasmTtsEngine\*\background_compiled.js",
    "C:\Users\*\AppData\Local\Spotify\WasmTtsEngine\*\bindings_main.js",
    "C:\Users\*\AppData\Local\Spotify\WasmTtsEngine\*\offscreen_compiled.js",
    "C:\Users\*\AppData\Local\Spotify\WasmTtsEngine\*\streaming_worklet_processor.js",
    "C:\Windows\assembly\*\GemBox.Spreadsheet.dll",
    "C:\Windows\assembly\*\*.ni.dll",
    "C:\Windows\Installer\b4d*.msi",
    "C:\Windows\Installer\edd*.msi",
    "C:\Windows\Logs\CBS\*.cab",
    "C:\Windows\System32\spool\drivers\*\*.cab",
    "C:\Windows\System32\7z.dll",
    "C:\Windows\System32\Sens_oal.dll",
    "C:\Windows\SysWOW64\mfc7*.dll",
    "C:\Windows\SysWOW64\msvbvm50.dll",
    "C:\Windows\SysWOW64\NIScale.dll",
    "C:\Windows\SysWOW64\Sens_oal.dll",
...
$whitelistPastas = @(
    ...
    "C:\Windows\assembly",
    "$whitelistUserProfile\AppData\Local\Microsoft\Windows"
)
...
"C:\Users\$env:USERNAME\AppData\Local\BraveSoftware\Brave-Browser\User Data\Default\Cache\Cache_Data\f_000664"
"C:\Users\$env:USERNAME\AppData\Local\Microsoft\Edge\User Data\Default\Cache\Cache_Data\f_000106"
...
Where-Object {
    ...
    $whitelistArquivos -notcontains $filePath -and
    -not ($whitelistPastas | Where-Object {
        $filePath -ieq $_ -or $filePath -like "$_\*"
    }) -and
    -not ($appWhitelistFiles | Where-Object {
        $filePath -ieq $_ -or $filePath -like $_
    })
} |
ForEach-Object {
...
$locais = @(
    "C:\Program Files",
    "C:\Program Files (x86)",
    "$whitelistUserProfile\AppData\Local",
    "$whitelistUserProfile\AppData\Roaming"
)
...
$imageLoadedWhitelist = @(
    ...
    "C:\Users\*\Downloads\PIN-*.exe",
    "$whitelistUserProfile\Downloads\vibranceGUI.exe",
    "C:\Users\*\Downloads\vibranceGUI.exe",
    "$whitelistUserProfile\Downloads\gcapi.dll",
    "C:\Users\*\Downloads\gcapi.dll",
    "$whitelistProgramFiles\WindowsApps\Microsoft.ZuneVideo_*\*",
    "C:\ProgramData\BlueStacks\CefData\chrome_elf.dll",
...
try {
    ...
    $CommandWhitelist = @(
        ...
        [PSCustomObject]@{
            ...
            ParentImage       = "C:\Program Files\NVIDIA Corporation\NvContainer\nvcontainer.exe"
            Image             = "rundll32.exe"
            ParentCommandLine = '(?i)(?:^|\s)-s\s+NvContainerLocalSystem(?:\s|$)'
            CommandLine       = '(?i)"?C:\\Program Files\\NVIDIA Corporation\\NVIDIA App\\ShadowPlay\\nvspapi64\.dll"?\s+#(?:14\s+3736\s+-org=Unknown|15\s+3736\s+-org=ServiceRestart)(?:\s|$)'
        },
        ...
        [PSCustomObject]@{
            ...
            Image             = "powershell.exe"
            EncodedCommand    = ''
        }
    )
    ...
    foreach ($evt in $CommandEvents) {
        ...
        foreach ($rule in $CommandWhitelist) {
            ...
            if (
                $rule.EncodedCommand -and
                ($cmd -notmatch [regex]::Escape($rule.EncodedCommand))
            ) {
                continue
            }
